...
remote=njb2b@portal.cs.virginia.edu:public_html/cstheory/f2022
...
function upfile_inner() {
    ...
    then
        ...
        $pd --standalone \
            ...
            --number-sections \
            --title-prefix="Theory of Computation" \
...
then
    echo "doing schedule"
    python3 cal2html.py
    scp "assignments.json" "/var/www/html/cstheory/meta/"
    scp "coursegrade.json" "/var/www/html/cstheory/meta/"
    scp "course.json" "/var/www/html/cstheory/meta/"
fi

...
Implement a one-bit Full Adder below. You may use only NANDor any of the sugary functions provided above."""
...
def ADD4(a3, a2, a1, a0, b3, b2, b1, b0):
    carry, r2, r1, r0 = ADD3(a2, a1, a0, b2, b1, b0)
    r4, r3 = FADD1(a3, b3, carry)
    return r4, r3, r2, r1, r0

def ADD5(a4, a3, a2, a1, a0, b4, b3, b2, b1, b0):
    carry, r3, r2, r1, r0 = ADD4(a3, a2, a1, a0, b3, b2, b1, b0)
    r5, r4 = FADD1(a4, b4, carry)
